<header class="bg-white">
	<nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
		<div class="flex lg:flex-1">
			<a href="#top" class="-m-1.5 p-1.5" id="top">
		...
		<div class="hidden lg:flex lg:gap-x-12">
			<a href="/todosb" class="text-sm font-semibold leading-6 text-gray-900">TodoSB</a>
			...
			<a href="/todo-client-only" class="text-sm font-semibold leading-6 text-gray-900"
				>TodoClientOnly</a
			>
			<a href="/add" class="text-sm font-semibold leading-6 text-gray-900">Add API</a>
		</div>
		<div class="hidden lg:flex lg:flex-1 lg:justify-end">
			<a href="auth/signout" class="text-sm font-semibold leading-6 text-gray-900"
